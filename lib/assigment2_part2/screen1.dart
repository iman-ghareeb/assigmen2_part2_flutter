...
import 'package:root/assigment2_part2/course_item.dart';
      ...
      body: Padding(
        ...
        child:ListView.separated(
            itemBuilder: (context,index)=>CourseItem(
              description:coursesData[index].description,
              image: coursesData[index].image,
              text: coursesData[index].text,
              goToDetails: (){
                Navigator.push(context, MaterialPageRoute(
                    builder: (context)=> CourseDetailsScreen(image: coursesData[index].image,description: coursesData[index].description)));
              },
            ),
...
class CoursesData{
  ...
  CoursesData(  {required this.image, required this.description,required this.text, });
}
